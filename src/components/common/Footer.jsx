...
const Services = [
  {
    name: "Detect Image",
    link: "https://aikavach.streamlit.app/",
  },
  {
    name: "Detect Audio",
    link: "https://aikavach.streamlit.app/",
  ...
  {
    name: "Image Detection Package",
    link: "https://pypi.org/project/deepfake-image-detection/",
  },
];
    ...
    <div className="bg-richblack-800">
      <div className="grid grid-cols-1 text-center sm:text-left sm:grid-cols-2 lg:grid-cols-4 justify-between  gap-y-10 w-11/12 max-w-maxContent text-richblack-400 leading-6 mx-auto relative py-14">
        ...
        <div className="flex flex-col gap-5 items-center sm:items-start">
          ...
          <p className="text-xs">Copyright © 2024 DesiCoder's</p>
